...
**0.3.9:** DNS defaults prefer Mullvad tunnel DNS (`10.64.0.1`); pair with **spectred ≥ 0.3.11**. **0.3.8:** Exclude apps (instances, Firefox profile copy, Tabler badge). **0.3.7:** clearnet netns.
