...
| `mark.svg` / `mark-light.svg` | App mark (path-distance glyph) |
| `globe.svg` | Reach territories sidebar nav |
| `map-cn.svg` / `mainland-china.svg` | China silhouette on territory page |
| `map-ir.svg` `map-ru.svg` `map-tr.svg` `map-cu.svg` `map-ae.svg` | Territory silhouettes |
