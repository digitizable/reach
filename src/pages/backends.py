...
class BackendsPage(Gtk.Box):
    def __init__(
        ...
        *,
        ...
        self._detail_kind = Gtk.Label(label="", xalign=0.5)
        self._detail_kind.add_css_class("detail-meta")
        self._detail_kind.set_halign(Gtk.Align.CENTER)
        self._detail_body.append(self._detail_kind)

        self._detail_status = Gtk.Label(label="", xalign=0.5, wrap=True)
        self._detail_status.add_css_class("muted")
        self._detail_status.set_halign(Gtk.Align.CENTER)
        self._detail_status.set_justify(Gtk.Justification.CENTER)
        self._detail_body.append(self._detail_status)

        self._detail_notes = Gtk.Label(label="", xalign=0.5, wrap=True)
        self._detail_notes.add_css_class("muted")
        self._detail_notes.set_halign(Gtk.Align.CENTER)
        self._detail_notes.set_justify(Gtk.Justification.CENTER)
