...
NAV_ITEMS: tuple[NavItem, ...] = (
    NavItem(
        ...
        tooltip="Status · Connect / Disconnect",
        section="run",
    ),
    NavItem(
        id="paths",
        ...
        tooltip="Recipes and adapters (config only)",
    ...
    NavItem(
        ...
        tooltip="Region ingress setup (config only)",
    ...
    NavItem(
        ...
        tooltip="Clearnet launch while the path protects the rest",
        section="workspace",
    ),
    NavItem(
        id="tools",
        ...
        tooltip="Diagnostics and lab tools (not session control)",
        section="workspace",
    ),
    NavItem(
        id="marketplace",
    ...
    NavItem(
        ...
        tooltip="Preferences · core · network · privacy",
        section_start=True,
        section="system",
    ),
)
